...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ToDo, null), window.app);
...
!function (factory) {
	...
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, exports) {
		...
		switch (length) {
			...
			default:
				return function () {
					...
					return base[method].apply(base, _toConsumableArray(args));
				};
		}
	};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ModelResponder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CollectionResponder; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_underscore__ = __webpack_require__(7);
...
var ModelResponder = function (_React$Component) {
	_inherits(ModelResponder, _React$Component);

	function ModelResponder() {
		var _ref;

		var _temp, _this, _ret;

		_classCallCheck(this, ModelResponder);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ModelResponder.__proto__ || Object.getPrototypeOf(ModelResponder)).call.apply(_ref, [this].concat(args))), _this), _this.update = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.debounce(function () {
			return _this.forceUpdate();
		}), _temp), _possibleConstructorReturn(_this, _ret);
	}

	_createClass(ModelResponder, [{
		...
		value: function subscribe() {
			...
			this.props.bind.forEach(function (attr) {
				_this2.props.target.on('change:' + attr, _this2.update, _this2);
			});
		}
	}, {
		key: 'unsubscribe',
		...
		value: function render() {
			...
			return (_props = this.props).children.apply(_props, _toConsumableArray(this.props.bind.map(function (attr) {
				return _this3.props.target.get(attr);
			}))) || null;
		}
	}]);
...
var CollectionResponder = function (_React$PureComponent) {
	_inherits(CollectionResponder, _React$PureComponent);

	function CollectionResponder() {
		var _ref2;

		var _temp2, _this4, _ret2;

		_classCallCheck(this, CollectionResponder);

		for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
			args[_key2] = arguments[_key2];
		}

		return _ret2 = (_temp2 = (_this4 = _possibleConstructorReturn(this, (_ref2 = CollectionResponder.__proto__ || Object.getPrototypeOf(CollectionResponder)).call.apply(_ref2, [this].concat(args))), _this4), _this4.update = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.debounce(function () {
			return _this4.forceUpdate();
		}), _temp2), _possibleConstructorReturn(_this4, _ret2);
	}

	_createClass(CollectionResponder, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			this.subscribe();
			if (typeof this.props.onMount === 'function') this.props.onMount();
		...
		value: function subscribe() {
			...
			if (this.props.bind) this.props.bind.forEach(function (attr) {
				_this5.props.target.on('change:' + attr, _this5.update, _this5);
			});
		...
		value: function render() {
			...
			return (_props2 = this.props).children.apply(_props2, _toConsumableArray(this.props.bind.map(function (attr) {
				return _this6.props.target.get(attr);
			}))) || null;
		}
	}]);

	return CollectionResponder;
